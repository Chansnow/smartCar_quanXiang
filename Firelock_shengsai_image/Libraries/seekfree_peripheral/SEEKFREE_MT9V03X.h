...
#define MT9V03X_W              Col           //图像宽度  范围1-752       RT102X RT105X RT106X 采集时列宽度必须为4的倍数
#define MT9V03X_H              Row             //图像高度   范围1-480
...
//--------------------------------------------------------------------------------------------------
#define MT9V03X_DATA_PIN        GPIO_IDR_ADDR(1, 0)
...
void uart_send(UARTN_enum uartn, uint8 *image, uint16 len);
