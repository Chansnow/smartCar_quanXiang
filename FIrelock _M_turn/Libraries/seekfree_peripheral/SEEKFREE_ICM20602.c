...
void icm20602_init_spi(void)
{
    ...
    icm_spi_w_reg_byte(ICM20602_CONFIG,         0x03);            //41HZ 1KHZ//0x01  176HZ 1KHZ
    ...
    icm_spi_w_reg_byte(ICM20602_ACCEL_CONFIG_2, 0x26);            //Average 8 samples   5.1HZ//0x03 Average 4 samples   44.8HZ   //0x23 Average 16 samples
}
